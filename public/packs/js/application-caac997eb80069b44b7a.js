    ...
    form.addEventListener('ajax:before', function (e) {
      if (form.dataset.isComplete !== 'true') {
        ...
        var onFinalSelectionChange = function onFinalSelectionChange() {
          ...
          form.querySelector('input[name="wit_ai_parse_model_example[parsable_resource_entity_value_start_index]"]').value = 3;
          form.querySelector('input[name="wit_ai_parse_model_example[parsable_resource_entity_value_end_index]"]').value = 3;
...
/******/ });
//# sourceMappingURL=application-caac997eb80069b44b7a.js.map