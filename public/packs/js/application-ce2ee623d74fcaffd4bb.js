  ...
  document.querySelectorAll('form[action="/wit_ai_parse_model_examples"]').forEach(function (form) {
    form.addEventListener('ajax:before', function (e) {
      if (form.dataset.isComplete !== 'true') {
        ...
        entityValueMarking.addEventListener('selectionchange', function () {
          console.log(document.getSelection());
          var isConfirmed = confirm('Confirm this property value? ' + document.getSelection());
...
/******/ });
//# sourceMappingURL=application-ce2ee623d74fcaffd4bb.js.map