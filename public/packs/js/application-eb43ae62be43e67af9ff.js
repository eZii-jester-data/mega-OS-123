...
document.addEventListener("turbolinks:load", function () {
  var form = document.querySelector('form[action="/wit_ai_parse_model_examples"]');
  form.addEventListener('ajax:before', function (e) {
    if (form.dataset.isComplete === 'false') {
      e.preventDefault();
    } else {
      form.dataset.isComplete = 'trues';
    }
...
/******/ });
//# sourceMappingURL=application-eb43ae62be43e67af9ff.js.map