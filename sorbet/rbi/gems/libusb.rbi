...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/libusb/all/libusb.rbi
#
# libusb-0.6.4
module LIBUSB
...
class LIBUSB::Device
  def <=>(o); end
  def bDescriptorType; end
  def bDeviceClass; end
  def bDeviceProtocol; end
  def bDeviceSubClass; end
  def bLength; end
  def bMaxPacketSize0; end
  def bNumConfigurations; end
  def bcdDevice; end
  def bcdUSB; end
  def bus_number; end
  def config_descriptor(index); end
  def configurations; end
  def context; end
  def device_address; end
  def device_speed; end
  def endpoints; end
  def iManufacturer; end
  def iProduct; end
  def iSerialNumber; end
  def idProduct; end
  def idVendor; end
  def initialize(context, pDev); end
  def inspect; end
  def interfaces; end
  def manufacturer; end
  def max_iso_packet_size(endpoint); end
  def max_packet_size(endpoint); end
  def open; end
  def open_interface(interface); end
  def parent; end
  def port_number; end
  def port_numbers; end
  def port_path; end
  def product; end
  def serial_number; end
  def settings; end
  def try_string_descriptor_ascii(i); end
  include Comparable
end
class LIBUSB::Configuration < FFI::ManagedStruct
  include Comparable
end
