...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post widgets_url, params: { widget: { web_assembly_code: @widget.web_assembly_code } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { web_assembly_code: @widget.web_assembly_code } }
